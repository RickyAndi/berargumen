...
describe('Card component', function() {
    ...
    var vmA, vmB, cardIndex, selectCardCallback, userDataFromServer, cardDataFromServer, cardDataFromServerB, cardInstance, userInstance, cardCreatorInstance, relationInstance;
